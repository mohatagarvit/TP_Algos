...
void initVisAllotted(Ans ans, int s, int d, vector< vector<int> > &visAllotted){
    for(int i=0; i<s; i++){
        for(int j=0; j<d; j++){
...
void initRowCol(Ans ans, vector< vector<int> > &row, vector< vector<int> > &col, int s, int d){
...
bool checkVisitedAll(pathCost pCost, vector< vector<int> > visAllotted){
